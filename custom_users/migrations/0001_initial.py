    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('J', 'Job Site'), ('M', 'Home'), ('C', 'Company'), ('O', 'Other')], default='M', max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='_contact_info', to='custom_users.contact')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='_client_list', through='custom_users.VendorCustomer', to='custom_users.contact'),
        ),
    ]
